...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#1b2738] text-white pt-10 pr-40" >
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-1">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2"><Home size={18} /> Lorem Ipsum, 2046 Lorem Ipsum</li>
            <li className="flex items-center gap-2"><Phone size={18} /> 576-245-2478</li>
            <li className="flex items-center gap-2"><Mail size={18} /> info@kapee.com</li>
            <li className="flex items-center gap-2"><Clock size={18} /> Mon - Fri / 9:00 AM - 6:00 PM</li>
          </ul>
        </div>
        ...
        <div className="w-50">
          ...
          <p className="text-sm mb-2">Subscribe to our mailing list to get new updates!</p>
          <div className="flex flex-col sm:flex-row gap-2 mb-3">
  <input
    type="email"
    placeholder="Your email address"
    className="px-3 py-2 rounded-l-md flex-1 text-black"
  />
  <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-r-md whitespace-nowrap transition-colors duration-200">
    SIGN UP
  </button>
</div>
          ...
          <div className="flex gap-2 flex-wrap">
            <div className="bg-blue-800 w-8 h-8 flex items-center justify-center rounded"><span>F</span></div>
            <div className="bg-black w-8 h-8 flex items-center justify-center rounded"><span>X</span></div>
            <div className="bg-blue-500 w-8 h-8 flex items-center justify-center rounded"><span>in</span></div>
            <div className="bg-pink-600 w-8 h-8 flex items-center justify-center rounded"><span>I</span></div>
            <div className="bg-pink-500 w-8 h-8 flex items-center justify-center rounded"><span>F</span></div>
            <div className="bg-orange-500 w-8 h-8 flex items-center justify-center rounded"><span>RSS</span></div>
            <div className="bg-red-600 w-8 h-8 flex items-center justify-center rounded"><span>YT</span></div>
          </div>
        </div>
      </div>
