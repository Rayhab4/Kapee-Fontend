  ...
  return (
    <section className="px-6 py-10 bg-gray-50">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Card 1 */}
        <div className="flex items-center justify-between bg-white shadow-sm p-6 border-r-8 rounded-lg">
          {/* Left text */}
          <div>
          ...
          {/* Right image */}
          <div className="w-40 h-40 md:w-48 md:h-48 flex-shrink-0 mr-20">
            <img
